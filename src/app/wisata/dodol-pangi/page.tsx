  ...
  return (
    <>
      ...
      <main className="font-sans">
        ...
        <section className="bg-white max-w-full mx-auto py-6 sm:py-12 px-6 sm:px-12 md:px-40 grid md:grid-cols-2 gap-6 sm:gap-10 items-center">
          ...
          <div className="text-center bg-[#4AC2AD1F] py-6 sm:py-10 px-4 sm:px-10 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <p className="text-xs sm:text-base md:text-lg text-black leading-relaxed text-justify sm:text-center">
              ...
              Menikmati Dodol Pangi bukan hanya soal rasa, tetapi juga
              menghargai warisan kuliner yang dibuat dengan ketelatenan dan
              cinta oleh masyarakat Gattareng Toa.
            </p>
          </div>
        ...
        {/* Bahan & Pembuatan */}
        <section className="bg-[#F8F9FA] max-w-full mx-auto py-8 sm:py-12 px-6 sm:px-12 md:px-40 flex flex-col md:flex-row gap-6 sm:gap-10 items-start md:items-center">
          {/* Bahan */}
          <div className="text-center bg-[#01afef1c] py-6 px-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 w-full sm:w-[340px]">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#4AC2AD] mb-2">
              BAHAN
            </h2>
            <ul className="text-xs sm:text-base md:text-lg text-black leading-relaxed text-left list-disc list-inside pl-6">
              <li>Pangi muda</li>
              <li>Gula merah</li>
              <li>Tepung ketan</li>
              <li>Tepung terigu</li>
          ...
          {/* Cara Membuat */}
          <div className="bg-[#4AC2AD1F] py-6 px-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 w-full md:w-[600px]">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#01AFEF] mb-2 text-center">
              CARA MEMBUAT
            </h2>
            <ol className="list-decimal list-inside text-xs sm:text-base md:text-lg text-black leading-relaxed space-y-1 pl-6">
        ...
        {/* Harga */}
        <section className="max-w-full mx-auto py-8 sm:py-12 px-6 sm:px-12 bg-white">
            ...
            {hargaItems.map((item, i) => (
              ...
              >
                <Image
                  ...
                  width={300}
                  height={200}
                  className="w-full h-32 sm:h-50 object-cover"
                />
                ...
                <a
                  ...
                  className="mt-2 mb-4 mx-3 inline-block bg-[#4AC2AD] text-xs sm:text-sm text-white px-4 py-2 rounded-lg shadow hover:bg-[#3AA495] transition"
                >
                  Pesan Sekarang
                </a>
              </div>
        ...
        <section
          id="galeri"
          className="max-w-full mx-auto py-8 sm:py-12 px-6 sm:px-12 bg-[#F8F9FA]"
        >
